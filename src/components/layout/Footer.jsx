...
const footerLinks = {
  ...
  categorias: [
    ...
    { label: 'Smartwatch', href: '/categoria/smartwatch' },
    { label: 'Accesorios', href: '/categoria/accesorios' },
    { label: 'Cargadores', href: '/categoria/cargadores' },
    { label: 'Periféricos', href: '/categoria/perifericos' },
    { label: 'Gadgets', href: '/categoria/gadgets' },
  ],
  ayuda: [
...
const trustItems = [
  ...
  { icon: Shield, title: 'Garantía oficial', desc: 'Todos los productos' },
]
      ...
      <div className="container-custom py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-6" aria-label="Sisley - Inicio">
