...
const navItems = [
  ...
  { href: '/admin/clientes', label: 'Clientes', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
  { href: '/admin/facturacion', label: 'Facturación', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-sisley-white border-r border-sisley-gray-200 min-h-[calc(100vh-64px)]">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center gap-3 px-4 py-3 text-xs uppercase tracking-widest transition-all duration-200 ${
                isActive
                  ? 'bg-sisley-black text-white'
                  : 'text-sisley-gray-600 hover:bg-sisley-gray-50 hover:text-sisley-black'
              }`}
            >
