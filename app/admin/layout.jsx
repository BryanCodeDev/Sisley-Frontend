            ...
            <div className="flex items-center justify-between h-14 px-6 lg:px-10">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-xs font-medium text-sisley-text">Admin Sisley</p>
                  <p className="text-[10px] text-sisley-muted">admin@sisley.co</p>
                </div>
                <div className="w-8 h-8 bg-sisley-border rounded-full flex items-center justify-center">
                  <span className="text-[10px] font-medium text-sisley-text">A</span>
                </div>
              </div>
            </div>
          </header>
